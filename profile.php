...
<html lang="en">
  ...
  <body id="page-top">
    ...
    <div class="col-lg-9" id="content" style="margin-top:80px;">
                <div id="inside_c">
                <center>
                  <br/>
                <h2 style="color:#DAA520; font-family:calibri !important">Personal Information</h2></center>
                <?php
                $u=$_SESSION['username'];
                ...
                while($row = mysqli_fetch_array($result))
                {
                    ...
                    echo "<p class='tem'>Email: <b>$email</b></p>";
                    echo "<p class='tem'>Country: <b>$country</b></p>";
                    echo "<p class='tem'>Age: <b>$age</b></p>";
